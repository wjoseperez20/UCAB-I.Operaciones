...
class Simulacion:
    ...
    def Imprimir(self):
        ...
        workbook = xlsxwriter.Workbook("output/PoliticaDos_"+str(self.__iterator)+".xlsx")
    ...
    def __CrearTablaCorridasExcel(self, worksheet):
        ...
        worksheet.write(1, 5, "COMPRA DIA 10", self.__cell_format_header)
        worksheet.write(1, 6, "ALEATORIO #2", self.__cell_format_header)
    ...
    def __LlenarTablaCorridasExcel(self, worksheet):
        ...
        for resultado in self.listaOrdenada:
            ...
            worksheet.write(row, 5, resultado.Get_CompraDia10(), self.__cell_format)
            worksheet.write(row, 6, resultado.Get_Random2(), self.__cell_format)
            worksheet.write(row, 7, resultado.Get_SegundaDemanda(), self.__cell_format)
            worksheet.write(row, 8, resultado.Get_SobranteFinal(), self.__cell_format)
